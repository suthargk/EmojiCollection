...
export default function SearchEmoji({ type = "text", id, value, handleSearch, setSearchTerm }) {
  return (
    <div className="search-emoji">
      ...
      <label htmlFor={id}>
        ...
        {value ? <button className="close-button" onClick={() => setSearchTerm("")}><Close className="close-svg"/></button> : <button className="search-button"><Search className="search-svg" /></button>}
      </label>
